...
namespace WkyFast.Service
{
    public class WkyAccountManager
    {
        ...
        public static ObservableCollection<WkyApiSharp.Service.Model.ListPeer.ResultClass> PeerList { set; get; } = 
            new ObservableCollection<WkyApiSharp.Service.Model.ListPeer.ResultClass>();

        public static WkyApiSharp.Service.Model.ListPeer.ResultClass NowPeer { set; get; }
        ...
        public static WkyApiSharp.Service.Model.ListPeer.Device[]? GetNowPeerDevices()
        {
            if (NowPeer != null && NowPeer.Devices != null)
            {
                return NowPeer.Devices;
            }
            return null;
        }
        ...
        public static void GetWkyAccountData()
        {
            ...
            {
                NowPeer = PeerList.First();
                foreach (var device in NowPeer.Devices)
                {
                    //获取磁盘设备分区信息
                    var diskInfo = wkyApi.GetUsbInfo(device.DeviceId).Result;
                }
